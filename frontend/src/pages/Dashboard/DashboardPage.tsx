...
import type { DashboardData } from '../../services/progress.service';
          ...
          {stats.map((stat) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`flex items-center justify-center w-11 h-11 rounded-xl bg-linear-to-br ${stat.gradient} shadow-lg ${stat.shadowColor} group-hover:scale-110 transition-transform duration-300`}
                >
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-sm text-slate-500 pl-4">{new Date(activity.timestamp).toLocaleString()}</p>
                      </div>
                      {activity.link && (
                        <a
                          href={activity.link}
